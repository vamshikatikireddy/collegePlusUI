...
const Login: React.FC = () => {
  ...
  const canSubmit =
    EMAIL_REGEX.test(email) && password.length > 0 && !loading;
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <EmailIcon
                      sx={{ color: emailError ? 'error.main' : 'text.secondary', fontSize: 20 }}
                    />
                  </InputAdornment>
                ),
              }}
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <LockIcon
                      sx={{ color: passwordError ? 'error.main' : 'text.secondary', fontSize: 20 }}
                    />
                  </InputAdornment>
                ),
                endAdornment: (
