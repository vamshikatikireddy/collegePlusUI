...
const Profile: React.FC = () => {
  ...
  const infoItems = [
    ...
    { icon: <BadgeOutlined />, label: 'Student ID', value: profileData.studentId },
    { icon: <SchoolRounded />, label: 'Department', value: profileData.department },
    {
    ...
    >
      ...
      >
        <Card sx={{ flex: 1, textAlign: 'center', py: 2.5 }}>
          <CircularProgressBar value={profileData.attendancePercent} size={64} color="#69F0AE" />
      ...
      >
        ...
        <Stack spacing={2} divider={<Divider sx={{ borderColor: 'rgba(148,163,184,0.06)' }} />}>
          {infoItems.map((item) => (
